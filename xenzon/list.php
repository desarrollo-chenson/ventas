...
<section>
  ...
  <div class="container">
    <div class="row">
        <a class="btn btn-outline-dark" href="upload.php">Regresar</a>
    </div>
    <div class="row">
        ...
        if (isset($_POST['enviar']))
        {
          ...
          while( ($data = fgetcsv($handle, 1000, ";") ) !== FALSE )
          {
            ...
            $queryResult = $pdo->query("SELECT * FROM xenzon2020 WHERE codigo IN('$data[0]')");
              while ($row = $queryResult->fetch(PDO::FETCH_ASSOC)) {

                $image = 'images/skus/'. $row['codigo'] .'.jpg';
                ...
                <img data-src="images/skus/'. $row['codigo'] .'.jpg" src="images/error.jpg" class="card-img-top d-flex justify-content-center pt-2" alt="imagen '. $row['codigo'] .'" onError="no_imagen(this)">
                </a>
                              <!-- link a modal -->
         ...
         <div class="row pb-5">
           <div class="input-group-prepend col-md-6 col-12 pt-3">
             <input type="submit" class="btn btn-sel col-12" name="submit" id="descargar" value="DESCARGAR PDF" onclick=this.form.action="pdf.php" >
