  ...
  <body>
      ...
      <section style="background: white;">
        ...
        $queryResult = $pdo->query("SELECT id, codigo, descripcion, coddescripcion, licencia, clave, color, temporada, material1, porcentaje1, material2, porcentaje2, material3,
          porcentaje3, forro, forroporcentaje, base, alto, ancho, asa, precio FROM nylontb WHERE codigo='$idproducto' LIMIT 0,1 ");
        ...
        <div class="container-fluid pt-md-5 pt-1 d-flex align-items-center" >
            <div class="container">
              <div class="row">
                ...
                -Bolsillo frontal con cierre.-Bolsillos laterales.
                </div>
                </div>
                </div>
                ...
                <a href="print-pdf.php?cod='. $row['codigo'] .'" class="btn btn-dark col-12 ">GENERAR PDF</a><br>
