...
if (!empty($_POST)){
  ...
  $sql = "INSERT INTO productosugerido (codigo, imagen, color, marca, precio, promocion, descripcion) VALUES ( :codigo, :imagen, :color, :marca, :precio, :promocion, :descripcion )";
...
<html lang="es" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Agregar producto sugerido</title>
