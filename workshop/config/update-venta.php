...
if (!empty($_POST)) {
    ...
    $sql = "UPDATE ventadeliquidacion SET codigo=:codigo, imagen=:imagen, color=:color, marca=:marca, precio=:precio, promocion=:promocion, descripcion=:descripcion WHERE id=:id";
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM ventadeliquidacion WHERE id=:id";
    $query = $pdo->prepare($sql);
      ...
      <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-6 col-12">
                <form  action="update-venta.php" method="post">
                  <div class="row">
                    <div class="col-6">
